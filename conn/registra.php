...
<h1>Registro</h1>
Nombres: <input name= "nombres"> <br/><br/>
Apellidos: <input name= "apellidos"> <br/><br/>
Fecha de Nacimiento: <input name= "edad"> <br/><br/>
Contraseña: <input name= "password"> <br/><br/>
<br/><br/>
Vincular correo para recibir notificaciones: <input   value="M" type= "radio" name= "notificacion"> <br/><br/>
<input type="submit"/>
</form> 
...
$sql = "INSERT INTO persona (nombre, apellidos, edad, password, notificacion)
VALUES ('$c', '$n', '$e', '$p', '$g')";
